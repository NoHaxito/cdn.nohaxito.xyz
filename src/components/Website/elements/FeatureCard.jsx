export default function Card(props) {
  return (
    <div className="flex flex-col items-center hover:bg-gray-100/70 dark:hover:bg-gray-700/70 hover:transform hover:-translate-y-1 hover:scale-110 duration-400 transition-all ease-in-out delay-200 rounded-lg py-4">
